...
const AnimationSection = () => {
  ...
  return React.createElement(
    ...
    {
      className:
        "absolute left-8 right-auto top-[10%] h-3/4 w-0.5 bg-[#facc31]/15 md:left-8",
    },
            ...
            <div className="grid grid-cols-[max-content_1fr] gap-x-6 lg:gap-x-10">
              <div className="relative flex flex-col items-center justify-center py-10 w-16">
                <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#facc31] to-[#FFD700] rounded-2xl flex items-center justify-center shadow-lg">
