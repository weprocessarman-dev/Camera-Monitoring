        ...
        <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2 lg:gap-x-20">
          ...
          <div className="order-1 md:order-2">
            ...
            <div className="mt-6 flex flex-wrap gap-4 md:mt-8 justify-end"> 
              <button 
                onClick={() => {
                  const gallerySection = document.getElementById('gallery-bento');
                  if (gallerySection) {
                    gallerySection.scrollIntoView({ behavior: 'smooth' });
                  }
                }}
                className="px-3 py-2.5 font-semibold transition-all duration-300 relative group flex items-center gap-2" 
