        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 py-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <p>1500 Main Street, Chicago IL 60601 USA</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid w-full items-center py-3 md:py-4">
            ...
            <RadioGroup className="grid grid-cols-2 gap-x-6 gap-y-3.5">
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="Retail store" id="#first_choice" />
                <Label htmlFor="#first_choice">Retail store</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#second_choice" />
                <Label htmlFor="#second_choice">Restaurant or bar</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#third_choice" />
                <Label htmlFor="#third_choice">Warehouse</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#fourth_choice" />
                <Label htmlFor="#fourth_choice">Office space</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#fifth_choice" />
                <Label htmlFor="#fifth_choice">Commercial plaza</Label>
              </div>
              <div className="flex items-center space-x-2">
